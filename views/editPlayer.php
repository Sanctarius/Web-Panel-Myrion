			...
			case "player_edit":
				switch ($_SESSION['user_level'])
				{
					...
					case 3:
						...
						$bankacc = intval($_POST["player_bank"]);
						$arrested = intval($_POST["player_arrest"]);					
						$update = "UPDATE players SET coplevel = '".$coplevel."', mediclevel = '".$mediclevel."', donatorlvl = '".$donatorlvl."', adminlevel = '".$adminlevel."', cash = '".$cash."', bankacc = '".$bankacc."', arrested = '".$arrested."', WHERE uid = '".$uID."' ";	
						if (!$db_connection->connect_errno) 
						{
							$result_of_query = $db_connection->query($update);
							echo "<div class='row'>";
		...
		<div class="row mtbox">
			...
			<div class="col-md-2 col-sm-2 box0">
				<div class="box1">
					...
					<h3> <?php echo $lang['donator'].": ".$row["donorlevel"];  ?> </h3>
				</div>
			</div>
			<div class="col-md-2 col-sm-2 box0">
				<div class="box1">
